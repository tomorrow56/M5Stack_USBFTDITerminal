...
const uint8_t FTDIMOD::epDataInIndex = 1;
const uint8_t FTDIMOD::epDataOutIndex = 2;
const uint8_t FTDIMOD::epInterruptInIndex = 3;

FTDIMOD::FTDIMOD(USB *p, FTDIMODAsyncOper *pasync, uint16_t idProduct) :
pAsync(pasync),
pUsb(p),
bAddress(0),
bNumEP(1),
...
uint8_t FTDIMOD::Init(uint8_t parent, uint8_t port, bool lowspeed) {
...
void FTDIMOD::EndpointXtract(uint8_t conf, uint8_t iface, uint8_t alt, uint8_t proto __attribute__((unused)), const USB_ENDPOINT_DESCRIPTOR *pep) {
...
uint8_t FTDIMOD::SetBaudRate(uint32_t baud) {
...
uint8_t FTDIMOD::SetModemControl(uint16_t signal) {
...
uint8_t FTDIMOD::SetFlowControl(uint8_t protocol, uint8_t xon, uint8_t xoff) {
...
uint8_t FTDIMOD::SetData(uint16_t databm) {
...
uint8_t FTDIMOD::RcvData(uint16_t *bytes_rcvd, uint8_t *dataptr) {
...
uint8_t FTDIMOD::SndData(uint16_t nbytes, uint8_t *dataptr) {
...
void FTDIMOD::PrintEndpointDescriptor(const USB_ENDPOINT_DESCRIPTOR* ep_ptr) {
